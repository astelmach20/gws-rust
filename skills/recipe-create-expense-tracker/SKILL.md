...
2. Add headers: `gwsr sheets +append --spreadsheet-id SHEET_ID --range 'Sheet1' --json-values '["Date", "Category", "Description", "Amount"]'`
3. Add first entry: `gwsr sheets +append --spreadsheet-id SHEET_ID --range 'Sheet1' --json-values '["2025-01-15", "Travel", "Flight to NYC", "450.00"]'`
