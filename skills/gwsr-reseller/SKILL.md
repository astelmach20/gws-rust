---
name: gwsr-reseller
description: "Google Workspace Reseller: Manage reseller customers and subscriptions."
metadata:
  version: 0.22.5
  openclaw:
...
```bash
gwsr reseller <resource> <method> [flags]
```
...
gwsr schema reseller.<resource>.<method>
```
