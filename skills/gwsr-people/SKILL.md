...
```bash
gwsr people <resource> <method> [flags]
```
...
| Command | Description |
|---------|-------------|
| [`+find`](../gwsr-people-find/SKILL.md) | Find people in your contacts or your organization's directory |
...
gwsr schema people.<resource>.<method>
```
