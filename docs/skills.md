...
> Auto-generated by `gwsr generate-skills`. Do not edit manually.
...
| Skill | Description |
|-------|-------------|
| [gwsr-drive-upload](../skills/gwsr-drive-upload/SKILL.md) | Google Drive: Upload a file with automatic metadata. |
| [gwsr-sheets-append](../skills/gwsr-sheets-append/SKILL.md) | Google Sheets: Append a row to a spreadsheet. |
| [gwsr-sheets-read](../skills/gwsr-sheets-read/SKILL.md) | Google Sheets: Read values from a spreadsheet. |
| [gwsr-gmail-send](../skills/gwsr-gmail-send/SKILL.md) | Gmail: Send an email. |
| [gwsr-gmail-triage](../skills/gwsr-gmail-triage/SKILL.md) | Gmail: Show unread inbox summary (sender, subject, date). |
| [gwsr-gmail-reply](../skills/gwsr-gmail-reply/SKILL.md) | Gmail: Reply to a message (handles threading automatically). |
| [gwsr-gmail-reply-all](../skills/gwsr-gmail-reply-all/SKILL.md) | Gmail: Reply-all to a message (handles threading automatically). |
| [gwsr-gmail-forward](../skills/gwsr-gmail-forward/SKILL.md) | Gmail: Forward a message to new recipients. |
| [gwsr-gmail-read](../skills/gwsr-gmail-read/SKILL.md) | Gmail: Read a message and extract its body or headers. |
...
| [gwsr-calendar-agenda](../skills/gwsr-calendar-agenda/SKILL.md) | Google Calendar: Show upcoming events across all calendars. |
| [gwsr-docs-write](../skills/gwsr-docs-write/SKILL.md) | Google Docs: Append text to a document. |
...
| [gwsr-events-renew](../skills/gwsr-events-renew/SKILL.md) | Google Workspace Events: Renew/reactivate Workspace Events subscriptions. |
...
| [gwsr-workflow-standup-report](../skills/gwsr-workflow-standup-report/SKILL.md) | Google Workflow: Today's meetings + open tasks as a standup summary. |
| [gwsr-workflow-meeting-prep](../skills/gwsr-workflow-meeting-prep/SKILL.md) | Google Workflow: Prepare for your next meeting: agenda, attendees, and linked docs. |
...
| [gwsr-workflow-weekly-digest](../skills/gwsr-workflow-weekly-digest/SKILL.md) | Google Workflow: Weekly summary: this week's meetings + unread email count. |
...
| [gwsr-script-push](../skills/gwsr-script-push/SKILL.md) | Google Apps Script: Upload local files to an Apps Script project. |
