...
//!
//! Types are re-exported from the `gws_rust_core` library crate.
...
/// [`gws_rust_core::discovery::fetch_discovery_document`] that automatically
/// uses the CLI's cache directory (`~/.config/gwsr/cache/`).
