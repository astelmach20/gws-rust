        ...
        if addrs.len() == 1 && addrs[0].name.is_none() {
            ...
            match profile_token {
                Err(e) => {
                    ...
                    eprintln!(
                        "Tip: run `gwsr auth login` and grant the \"profile\" scope \
...
pub(super) async fn dispatch_raw_email(
    ...
    if draft && !matches.get_flag("dry-run") {
        ...
        eprintln!("  gwsr gmail users.drafts.send --body '{{\"id\":\"<draft-id>\"}}'");
    }
...
EXAMPLES:
  ...
  gwsr gmail +reply --message-id 18f1a2b3c4d --body 'Adding Dave' --to dave@example.com
  gwsr gmail +reply --message-id 18f1a2b3c4d --body '<b>Bold reply</b>' --html
  gwsr gmail +reply --message-id 18f1a2b3c4d --body 'Updated version' -a updated.docx
...
EXAMPLES:
  ...
  gwsr gmail +reply-all --message-id 18f1a2b3c4d --body '<i>Noted</i>' --html
  gwsr gmail +reply-all --message-id 18f1a2b3c4d --body 'Notes attached' -a notes.pdf
  gwsr gmail +reply-all --message-id 18f1a2b3c4d --body 'Draft reply' --draft
...
EXAMPLES:
  ...
  gwsr gmail +forward --message-id 18f1a2b3c4d --to dave@example.com --cc eve@example.com
  gwsr gmail +forward --message-id 18f1a2b3c4d --to dave@example.com --body '<p>FYI</p>' --html
  gwsr gmail +forward --message-id 18f1a2b3c4d --to dave@example.com -a notes.pdf
  gwsr gmail +forward --message-id 18f1a2b3c4d --to dave@example.com --no-original-attachments
  gwsr gmail +forward --message-id 18f1a2b3c4d --to dave@example.com --draft
